...
function compile(initfile, outfile, modules, nodemodulesPath) {
...
function boot(initfile,outfile,nodemodulesPath) {
	visited = {}
	var root = new Node()
	...
	var modules = []
	walk(root,modules)
	compile(initfile,outfile,modules,nodemodulesPath)
}
module.exports = {
	compile: boot
}